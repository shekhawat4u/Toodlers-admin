...
const AddSIZE = () => {
  ...
  const deleteItem = (id) => {
    deleteData(`/api/product/productSIZE/${id}`).then((res) => {
      context.alertBox("success", "Product Size deleted successfully");
      getData();
    });
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (editId === "") {
      postData(`/api/product/productSIZE/create`, { name: name }).then(
        (res) => {
          context.alertBox("success", "Product Size added successfully");
          setTimeout(() => {
            getData();
            setName("");
            setIsLoading(false);
    ...
    if (editId !== "") {
      editData(`/api/product/productSIZE/${editId}`, { name: name }).then(
        (res) => {
          context.alertBox("success", "Product Size edited successfully");
          setTimeout(() => {
            getData();
            setName("");
            setIsLoading(false);
